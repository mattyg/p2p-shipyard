...
use crate::{filesystem::{AppBundleStore, BundleStore, FileSystem}, happs::{install::{enable_app, install_app, install_web_app}, update::{update_app, UpdateHappError}}, lair_signer::LairAgentSignerWithProvenance, launch::launch_holochain_runtime, sign_zome_call_with_client, HolochainRuntimeConfig};
...
impl HolochainRuntime {
    ...
    pub async fn enable_app(
        ...
        let admin_ws = self.admin_websocket().await?;
        let app_info = enable_app(&admin_ws, app_id).await?;
